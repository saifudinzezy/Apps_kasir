...
public class ILapPembelian extends javax.swing.JInternalFrame {
    KoneksiDB getCnn = new KoneksiDB();     
    Connection _Cnn;

    public ILapPembelian() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(".::Form Laporan Pembelian");
        ...
        jLabel3.setText("Form ini digunkan untuk mencetak data pembelian");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       switch (bulan){
           case 1 :
                try {
                new Cetak("./laporan/bulanpem/LapPembelianJan.jasper");
            } catch (Exception e) {
          ...
          case 2 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianFeb.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 3 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianMart.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 4 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianApr.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 5 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianMei.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 6 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianJuni.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 7 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianJuli.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 8 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianAgust.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 9 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianSept.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 10 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianOkt.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 11 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianNov.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          case 12 :
              try {
                new Cetak("./laporan/bulanpem/LapPembelianDes.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            } 
          break; //end
          default:
               try {
                new Cetak("./laporan/LapPembelian.jasper");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e);
            }  
              break;
